...
export function KBarCommandPalette({
  ...
  const actions = [
    // Quick Actions
    {
      ...
      perform: () => {
        // Add your stop chats logic here
        console.log("Stopping chats...");
      },
    ...
    },
    {
      ...
      perform: () => {
        // Add your start chats logic here
    ...
    {
      id: "team-activity",
      name: "Summarize My Team's Activity In The Last 30 Days",
      shortcut: ["t", "a"],
      keywords: "team activity summary report 30 days",
      icon: <User className="h-4 w-4 text-muted-foreground" />,
      perform: () => {
        // Add your team activity logic here
        console.log("Generating team activity summary...");
      },
      section: "Quick Actions",
    },
